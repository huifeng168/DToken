...
public class GridTag extends TagSupport {
	final static Logger log = Logger.getLogger(GridTag.class);
	...
	private String rowList="[15,30,45]";
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			for(int i=0;i<listGridColumn.size();i++){
				...
				String titleText=((ResourceBundleMessageSource)WebContext.getBean("messageSource")).getMessage(gridColumn.getTitle(),null,WebContext.getLocale());
				if(titleText==null||titleText.equals("")){
					titleText=gridColumn.getTitle();
				}
