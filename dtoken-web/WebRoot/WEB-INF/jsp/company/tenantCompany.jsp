...
<form id="actionForm"  method="post" type="label" autoclose="true"  action="<s:Base/>/company/update">
			...
			<table width="980"  class="datatable" >
				...
				<tr>
					...
					<th><spring:message  code="company.creation.date" />：</th>
					<td>
    		...
    		<input  id="submitBtn" class="button" style="width:100px" type="button" value="<spring:message  code="button.text.save" />"> 
