			...
			<div class="main">
		    	<div class="mainin">	
				  <table width="980px"  class="datatable" >
					<tbody>
					<tr>
						<th  width="180px" nowrap><spring:message  code="passwordpolicy.minlength" />：</th>
						<td  width="300px">
						...
						<th  width="180px"  nowrap><spring:message  code="passwordpolicy.maxlength" />：</th>
						<td  width="300px" nowrap><input type="text" id="maxLength" name="maxLength" class="int {required: true,digits:true,range:[3,20]}" title="" value="${model.maxLength}" maxlength="2"/>
							<b class="orange">*</b><label for="maxLength"></label>
						</td>
					</tr>
					<tr>
						<th><spring:message  code="passwordpolicy.lowercase" />：</th>
						<td nowrap>	
						...
						<th><spring:message  code="passwordpolicy.uppercase" />：</th>
						<td nowrap>	
					...
					<tr>
						<th><spring:message  code="passwordpolicy.digits" />：</th>
						<td nowrap>	
						...
						<th><spring:message  code="passwordpolicy.specialchar" />：</th>
						<td nowrap>	
					...
					<tr>
						<th><spring:message  code="passwordpolicy.attempts" />：</th>
						<td nowrap>	
						...
						<th><spring:message  code="passwordpolicy.duration" />(Unit:Hour)：</th>
						<td nowrap>	
					...
					<tr>
						...
						<th><spring:message  code="passwordpolicy.expiration" />(Unit:Day)：</th>
						<td nowrap>	
						...
						<th><spring:message  code="passwordpolicy.username" />：</th>
						<td nowrap>	
								<select  id="username" name="username"  class="select_t">
									<option  <c:if test="${1==model.username}">selected</c:if>  value="1"><spring:message  code="common.text.status.3"/></option>
									<option  <c:if test="${0==model.username}">selected</c:if>  value="0"><spring:message  code="common.text.status.4"/></option>
								</select>
								<label for="username"></label>
							</td>
					</tr>
					<tr>
						<th><spring:message  code="passwordpolicy.simplepasswords" />：</th>
						<td nowrap colspan="3">	
							<span class="intspan">
