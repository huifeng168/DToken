 		...
 		<form id="advanced_search_form">
 			<table   class="datatable">
	 			<tr>
		 			...
		 			<td width="120px"><spring:message  code="loginhistory.sourceip"/></td>
		 			<td width="360px">
						<input style="width:70%"  type="text" id="sourceIp" name="sourceIp"  title="" value=""/>
			 		</td>
			 </tr>
			 <tr>
	 				<td width="120px"><spring:message  code="common.text.startdate"/></td>
		 			<td width="360px">
		 				<input class="datetimepicker" name="startDate" type="text" >
		 			</td>
		 			<td width="120px"><spring:message  code="common.text.enddate"/></td>
		 			<td width="360px">
						<input class="datetimepicker"  style="width:70%"  type="text" id="endDate" name="endDate"  title="" value=""/>
			 		</td>
			 </tr>
			</table>
 		</form>
